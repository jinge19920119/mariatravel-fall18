...
$travel_booking_sub_sections = array(
    ...
    'frontpage'  => array( 'banner', 'about', 'blog' ),
...
foreach( $travel_booking_sections as $s ){
...
function travel_booking_customize_preview_js() {
    ...
    wp_enqueue_script( 'travel-booking-customizer', get_template_directory_uri() . '/inc/js/customizer.js', array( 'customize-preview', 'customize-selective-refresh' ), '20151215', true );
}
add_action( 'customize_preview_init', 'travel_booking_customize_preview_js' );

function travel_booking_customizer_scripts() {
    wp_enqueue_style( 'travel-booking-customize',get_template_directory_uri().'/inc/css/customize.css', TRAVEL_BOOKING_THEME_VERSION, 'screen' );
    wp_enqueue_script( 'travel-booking-customize', get_template_directory_uri() . '/inc/js/customize.js', array( 'jquery', 'customize-controls' ), '20170404', true );
}
