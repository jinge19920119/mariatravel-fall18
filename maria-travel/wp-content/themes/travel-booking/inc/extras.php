...
function travel_booking_categories(){
	...
	if ( 'post' === get_post_type() ) {
		...
		$categories_list = get_the_category_list( esc_html__( ' ', 'travel-booking' ) );
		if ( $categories_list ) {
...
function travel_booking_tags(){
	...
	if ( 'post' === get_post_type() ) {	
		...
		$tags_list = get_the_tag_list( '', esc_html_x( ' ', 'list item separator', 'travel-booking' ) );
		if ( $tags_list ) {
 ...
 */
function travel_booking_is_tbt_activated() {
